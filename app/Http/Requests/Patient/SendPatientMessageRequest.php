...
class SendPatientMessageRequest extends FormRequest
{
    /** @var list<int|string> */
    ...
    protected function prepareForValidation(): void
    {
        ...
        foreach (['message', 'client_message_uuid', 'urgent_guidance_version'] as $key) {
    ...
    public function after(): array
    {
        return [function (Validator $validator): void {
            $allowed = ['message', 'client_message_uuid', 'thread_version', 'urgent_guidance_version'];
