...
final class HospitalProcessCatalog
{
    ...
    private static function readiness(string $id): array
    {
        $overrides = [
            ...
            'D1' => 'Governed shared milestones now emit Laboratory Test, Specimen, Result, Ancillary Order, and Encounter relations; analyzer and multi-specimen fidelity await the lab satellites.',
            'D5' => 'Governed shared milestones now emit Imaging Study, Read, Report, Ancillary Order, and Encounter relations; scanner and multi-study fidelity await the radiology satellites.',
            'D6' => 'Shared imaging milestones emit Critical Result and Communication Task relations; responsible-team and closed-loop follow-up satellites remain incomplete.',
            'D7' => 'Shared pathology milestones emit AP Case, Specimen, Slide/Block, and Report relations; distinct block, slide, and pathologist assignments await pathology satellites.',
            'D11' => 'Shared pharmacy milestones emit Medication Order, Pharmacy Work, and Dose relations through administration; preparation and ADC resources await pharmacy satellites.',
            'D12' => 'Shared pharmacy milestones emit the medication readiness slice, but education, handoff, and departure-clearance objects remain outside this projection.',
