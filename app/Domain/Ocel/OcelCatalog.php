...
final class OcelCatalog
{
    ...
    public static function objectTypes(): array
    {
        return [
            ...
            'Ancillary Order' => ['lens' => 'clinical', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Imaging Study' => ['lens' => 'diagnostic', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Scanner' => ['lens' => 'resource', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Imaging Read' => ['lens' => 'diagnostic', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Critical Result' => ['lens' => 'diagnostic', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Communication Task' => ['lens' => 'handoff', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Laboratory Specimen' => ['lens' => 'diagnostic', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Laboratory Test' => ['lens' => 'diagnostic', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Analyzer' => ['lens' => 'resource', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Laboratory Result' => ['lens' => 'diagnostic', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'AP Case' => ['lens' => 'diagnostic', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Pathology Specimen' => ['lens' => 'diagnostic', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Pathology Slide / Block' => ['lens' => 'diagnostic', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Pathologist Assignment' => ['lens' => 'resource', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Diagnostic Report' => ['lens' => 'diagnostic', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Blood Bank Request' => ['lens' => 'diagnostic', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Blood Product Unit' => ['lens' => 'resource', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
            'Medication Order' => ['lens' => 'medication', 'source_system' => 'prod.ancillary_milestones', 'emitted' => true],
