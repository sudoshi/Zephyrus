...
function assertFoundationStillDormant() {
    ...
    const forbiddenFoundationValues = [
        ...
        activation?.clinical_approval_recorded,
        activation?.patient_content_released,
        activation?.feature_activated,
        activation?.pilot_enrollment_confirmed,
        activation?.source_connector_deployed,
