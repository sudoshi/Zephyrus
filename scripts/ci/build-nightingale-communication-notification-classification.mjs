        ...
        changed_sources: [
            {
                ...
                rationale:
                    "The upstream delta adds a staff-only, independently gated Flow 4D conformance scene read and governed exception-note proposal beside the existing staff Arena conformance read. It adds no Nightingale route, patient communication operation, notification provider, patient-native transport, delivery-state claim, or implementation permission, so routes/api.php remains rejected migration evidence.",
            },
        ],
    },
