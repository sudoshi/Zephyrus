...
return [
    ...
    /*
     * Categorical service-line palette — the visual identity each service line carries on
     * the native 4D map (Hummingbird) and any deployment surface that colors by service line.
     * Keyed by canonical service_line_code; legacy aliases fold onto the canonical color via
     * ServiceLineNormalizer before lookup. Surfaced through GET /api/mobile/v1/flow/spaces3d
     * as the `service_lines` legend so iOS/Android read one source of truth (no palette drift).
     *
     * This is a DATA-VIZ categorical palette (a sanctioned exception to the two-system rule —
     * see DESIGN.md / CLAUDE.md Token Canon), NOT status color. It deliberately avoids the
     * reserved operational-status hues (teal #78BF70 occupied, amber #E0A340 dirty,
     * coral #EF6B5C blocked/breach, sky info) so the "what service is delivered here" channel
     * never reads as "this bed is in trouble." Hues are grouped by clinical family (medicine =
     * blues, women's/infants = pinks, surgery/procedural = warm ambers/browns, critical/neuro =
     * violets, support/ambulatory = slate-greys) so neighborhoods read at a glance. Colors are
     * always paired with the labelled legend — never status-by-color-alone.
     */
    'service_line_colors' => [
        'emergency' => '#E8792B', // orange
        'trauma_acute_care_surgery' => '#D64550', // red (distinct from status coral)
        'critical_care' => '#8E5FBF', // violet
        'hospital_medicine' => '#3D85C6', // blue
        'adult_med_surg' => '#6FA8DC', // light blue
        'cardiovascular' => '#C1436D', // rose
        'neurosciences' => '#9B7EDE', // lavender
        'perioperative' => '#D9A441', // gold
        'orthopedics_spine' => '#B98A3C', // bronze
        'oncology' => '#B2559E', // magenta
        'womens_health' => '#E06BA5', // pink
        'neonatology' => '#F2A0C4', // light pink
        'pediatrics' => '#66B04A', // green
        'behavioral_health' => '#7E7BB8', // periwinkle
        'rehabilitation' => '#4FA890', // teal-green
        'imaging_diagnostics' => '#5E8CA8', // steel blue
        'laboratory_pathology' => '#7A9CB0', // slate blue
        'pharmacy_medication' => '#4AA6A0', // muted teal
        'renal_dialysis' => '#38A18C', // aqua-green
        'gastroenterology' => '#B08A4F', // tan
        'pulmonary_respiratory' => '#5CA3C4', // sky-steel
        'infectious_disease_infection_prevention' => '#94A94A', // olive
        'transplant' => '#C77D3C', // amber-brown
        'burn' => '#CE6A3A', // burnt orange
        'geriatrics_palliative' => '#8994A8', // blue-grey
        'primary_ambulatory' => '#6E8A9E', // muted steel
        'home_post_acute' => '#7C93A6', // dusty blue
        'logistics_support' => '#8A8F98', // grey
        'quality_research_education' => '#9AA0AA', // light grey
    ],

    // Fallback for spaces with no resolved service line (corridors, unassigned rooms).
    'service_line_unassigned_color' => '#556072',
