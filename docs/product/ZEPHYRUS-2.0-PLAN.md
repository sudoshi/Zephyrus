...
> reference in `docs/reference/hospital-operations-cockpit/` and built **additively** on the assets
...
The cockpit is not a new feature bolted onto Zephyrus; it is the **gravity well** that pulls the scattered sections back into one body. Anchored to `docs/reference/hospital-operations-cockpit/docs/COCKPIT_IMPLEMENTATION.md`, the north star is precise:
