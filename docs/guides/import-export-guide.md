...
We've established consistent patterns for exports and imports in our codebase. These standards are documented in `docs/guides/coding-standards.md`. Here's a quick summary:
