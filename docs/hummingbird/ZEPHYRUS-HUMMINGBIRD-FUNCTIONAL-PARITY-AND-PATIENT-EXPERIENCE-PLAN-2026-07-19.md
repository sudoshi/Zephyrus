...
3. iOS has a more complete Eddy entry experience and push implementation. Android now supports scoped, nonstreaming staff Eddy chat from its authorized context screen, but neither platform has the full mobile conversation-history/approval workflow and Android has notification channels but no complete FCM registration/delivery path.
...
| Eddy staff             | Chat, stream, conversations, approvals, context                                                                                                       | Chat and context experience                                                 | Context plus scoped nonstreaming chat                                                   | `IOS_LEAD`: Android has a verified contextual chat slice, but still lacks iOS's global entry and both clients lack mobile conversation-history/approval completion                    |
...
| Eddy chat/conversations                           | BFF and iOS exist; Android has scoped nonstreaming chat but lacks the full experience   | `NATIVE`                      | P1: global entry parity, streaming fallback, conversation retention/deletion policy   |
