...
- [ ] Regenerate shared JSON fixtures from server factories and decode them in PHP, Swift, and Kotlin CI. _(2026-07-24 partial: all eight current fixtures are now mandatory PHP, Swift, and Kotlin CI decode gates, and the three Flow fixtures already have a real-BFF regeneration test. The other five fixtures still require server-factory regeneration/provenance, so this combined item remains open.)_
...
- [ ] Establish generated/shared contracts and three-language fixture CI. _(2026-07-24 partial: three-language decode CI is now required for all eight shared staff fixtures and the stale KMP README claim is removed. Swift/Kotlin DTOs remain manually maintained, generator pin/input-hash/output-freshness controls have not landed, and five fixtures are not yet server-factory generated; generated/shared-contract completion is therefore still open.)_
