...
- [ ] Patient/family goals and preferences are visible to the care team. _(2026-07-25 partial: a patient can select a separately policy-released **What matters to you** preference or **A personal goal for my stay** topic in Messages. When the corresponding default-off feature, approved policy, active grant, and accountable handoff are available, the submission is an encrypted routed message to the internal care-team inbox; the optional preference/goal association is content-free and append-only. It cannot amend a clinical goal, care plan, order, consent, or assessment, and patient responses never expose the responsibility-pool identifier. My Path explains this boundary; the iPhone 17 Pro topic tests, Android API 35 message-topic journey, and the PHP messaging suite cover it. This stays open because no representative/family delegation, approved production policy/source, staff-review workflow validation, pilot, or activation authority exists.)_
