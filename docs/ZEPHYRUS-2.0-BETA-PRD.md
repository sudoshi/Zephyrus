...
1. `docs/ZEPHYRUS-2.0-BETA-PRD.md` - this document.
2. `docs/ZEPHYRUS-2.0-PLAN.md` - master Zephyrus 2.0 plan, with its Part II corrections taking precedence over its later chapters.
3. `docs/ZEPHYRUS-2.0-PART-X.md` - canonical companion for process intelligence and the Patient-Flow Arena.
...
5. `docs/EDDY-AI-AGENT-PLAN.md`, `docs/EDDY-LOCAL-AGENT-PATH.md`, and the Patient Flow 4D Barrier/Eddy plan - Eddy authority.
...
| File | Disposition |
|---|---|
| `docs/ZEPHYRUS-2.0-BETA-PRD.md` | Canonical beta PRD and north-star. Supersedes all prior planning documents where they conflict. |

### 3.2 Tier 1 - Primary Product Authority

| File | Disposition |
|---|---|
| `docs/ZEPHYRUS-2.0-PLAN.md` | Primary Zephyrus 2.0 master plan. Part II corrections win over later conflicts. |
| `docs/ZEPHYRUS-2.0-PART-X.md` | Canonical companion for object-centric process intelligence and Patient-Flow Arena. Beta includes the substrate/status; full Arena phases are post-beta unless explicitly enabled. |
| `docs/EDDY-AI-AGENT-PLAN.md` | Eddy architectural authority, corrected by local-agent and mobile devlogs where status has changed. |
| `docs/EDDY-LOCAL-AGENT-PATH.md` | Current local-agent status and gated remaining work. |
...
| `docs/SERVICE-LINE-LOCATION-DEPLOYMENT-TAXONOMY-2026-07-04.md` | Canonical service-line/location deployment taxonomy. |
...
| File | Disposition |
|---|---|
| `docs/Hospital Operations Cockpit/docs/COCKPIT_IMPLEMENTATION.md` | Cockpit layout/API/design reference. Use for layout grammar; reject any token/schema/facility assumptions that conflict with Zephyrus 2.0. |
| `docs/HOSPITAL-1-SUMMIT-REGIONAL-PLAN.md` | HOSP1/Summit demo-data unification plan. |
| `docs/HOSPITAL-1-EXECUTION-INTEL.md` | Verified HOSP1 execution intelligence. Supersedes older HOSP1 assumptions when specific. |
...
| File | Disposition |
|---|---|
| `docs/DEVLOG-application-completeness-2026-06-27.md` | Evidence for application-completeness tranche and route smoke baseline. |
| `docs/DEVLOG-authentik-sso-fleet-2026-06-22.md` | Evidence for Authentik SSO verification. |
| `docs/DEVLOG-cockpit-mount-anywhere-p8-2026-07-05.md` | Evidence for P8 mount-anywhere slice; verify current code before relying on details. |
| `docs/DEVLOG-command-center-resilience-adaptive-2026-06-26.md` | Evidence for command-center resilience work. |
| `docs/DEVLOG-flow-os-competitor-leapfrog-2026-06-26.md` | Evidence for Flow OS competitive tranche. |
| `docs/DEVLOG-hummingbird-ios-testflight-2026-06-28.md` | Hummingbird iOS/TestFlight status evidence. |
| `docs/DEVLOG-native-4d-viewer-2026-07-05.md` | Native 4D viewer status evidence; treat remaining uncommitted/open notes carefully. |
| `docs/DEVLOG-patient-flow-4d-navigator-2026-06-25.md` | Patient Flow 4D navigator shipped-state evidence. |
| `docs/DEVLOG-ui-consistency-remediation-2026-06-26.md` | UI consistency remediation shipped-state evidence. |
...
| `docs/RootCauseImprovementWorkflow.md` | Historical improvement workflow reference; superseded by v2.0 Study/Arena direction. |
| `docs/import-export-guide.md` | Pattern guide; keep as engineering reference. |
| `docs/coding-standards.md` | Engineering reference. |
| `docs/session-auth.md` | Session-auth reference. |
| `docs/csrf-solution.md` | Historical CSRF/auth reference. |
| `docs/no-login-solution.md` | Historical no-login/demo auth reference; do not use as beta auth authority. |
| `docs/EDDY-ABBY-TEARDOWN-EVIDENCE.md` | Raw Abby teardown evidence; useful only when explaining Eddy architecture choices. |
| `docs/APPLICATION-COMPLETENESS-AUDIT-AND-PLAN-2026-06-26.md` | Historical application-completeness baseline; useful for page inventory and unfinished-domain lineage, superseded by this PRD for beta planning. |
| `docs/UX-DENSITY-TIGHTENING-PLAN.md` | Supporting density rationale; not current design authority. |
| `docs/UI-CONSISTENCY-REMEDIATION-PLAN-2026-06-26.md` | Historical plan; use devlog plus this PRD for current rules. |
...
|---|---|
| One cockpit home and altitude IA | `ZEPHYRUS-2.0-PLAN.md`, cockpit implementation spec |
| Object-centric process roadmap | `ZEPHYRUS-2.0-PART-X.md` |
| Eddy governed action loop | `EDDY-AI-AGENT-PLAN.md`, `EDDY-LOCAL-AGENT-PATH.md`, Flow OS devlogs |
...
| HOSP1/Summit demo | `HOSPITAL-1-SUMMIT-REGIONAL-PLAN.md`, `HOSPITAL-1-EXECUTION-INTEL.md` |
| Service-line/location deployment | `SERVICE-LINE-LOCATION-DEPLOYMENT-TAXONOMY-2026-07-04.md`, implementation plan |
