...
- Scheduler, queue, cockpit snapshot refresh, Patient Flow snapshot, route registration, health endpoint, and vhost checks were smoked after the prior deployment. The final post-review hardening commit still requires clean-branch deploy and smoke checks.
