...
| AST-16   | Signing/build/release artifacts          | Provenance, exact SHA, no Debug hooks, authorized distribution           | Local evidence only; no distribution approval |
...
| CTRL-025   | Decorative bird imagery is nonessential and hidden under stronger contrast/transparency policy       | Native UI and tests                                     | Human patient review remains open                                                |
...
| THR-SC-001  | Supply chain           | Dependency, build runner, package registry, signing key, or store account is compromised                     | S5×L3 = 15 High     | Exact-SHA CI; local dependency inventory                                  | GATE-16, pinned/provenanced dependencies, vulnerability policy, signing/access audit             |
...
| ABUSE-017 | Turn off accessibility imagery while a future control relies on the bird/image            | Essential meaning and action remain textually and semantically available                 |
...
| ------------------ | ------------------------------------------------------------------------------------------ | --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Network absence    | No network client in source/binary scans                                                   | No `INTERNET` permission plus source/APK scans                  | Add explicit approved network stacks together with TLS/endpoint tests; never infer parity         |
...
| RISK-007 | No approved continuous dependency vulnerability/provenance response SLO                                       | Exact-SHA CI is insufficient; supply-chain program required                             |
...
| RISK-017 | Release/store signing, privacy declarations, backup/restore, upgrade, and supported-version behavior unproven | Local builds only; no distribution authorization                                        |
