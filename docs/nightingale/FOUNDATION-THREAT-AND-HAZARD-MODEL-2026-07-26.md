...
| RISK-017 | Release/store signing, privacy declarations, background rights/attribution, backup/restore, upgrade, and supported-version behavior unproven | Local code/media lineage and builds only; no distribution authorization                 |
