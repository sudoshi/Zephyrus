...
| [nightingale/](./nightingale/)     | Independent inpatient-facing product contracts, safety evidence, namespace, and migration lineage | [nightingale/README.md](./nightingale/README.md), [namespace and activation separation](./nightingale/NAMESPACE-AND-ACTIVATION-SEPARATION-FOUNDATION-2026-07-27.md), [controlled-pilot manifest](./nightingale/CONTROLLED-PILOT-MANIFEST-FOUNDATION-2026-07-27.md)   |
...
1. **Kind first.** A new Flow-4D plan goes in `plans/`, not a `flow-4d/` folder. Only a
   ...
   (`hummingbird/`, `nightingale/`, `home-hospital/`).
