...
If beta implements seven Patient Flow scenarios instead of all nine PRD demo scenarios, B4 must update `DECISION-REGISTER.md` D6 and `docs/product/beta-known-limitations.md` with the exact two scenarios handled outside Patient Flow.
