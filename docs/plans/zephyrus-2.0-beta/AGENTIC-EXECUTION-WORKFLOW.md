...
2. `docs/product/ZEPHYRUS-2.0-BETA-PRD.md`, once B0 decides its committed authority path.
3. This todo folder.
...
- [ ] Create or update the phase evidence directory:
  - `docs/plans/zephyrus-2.0-beta/evidence/<phase>/README.md`
  - `docs/plans/zephyrus-2.0-beta/evidence/<phase>/commands/`
  - `docs/plans/zephyrus-2.0-beta/evidence/<phase>/screenshots/`
  - `docs/plans/zephyrus-2.0-beta/evidence/<phase>/api/`
  - `docs/plans/zephyrus-2.0-beta/evidence/<phase>/mobile/`
  - `docs/plans/zephyrus-2.0-beta/evidence/<phase>/deploy/`
...
- docs/product/ZEPHYRUS-2.0-BETA-PRD.md.
- docs/plans/zephyrus-2.0-beta/<phase file>.
