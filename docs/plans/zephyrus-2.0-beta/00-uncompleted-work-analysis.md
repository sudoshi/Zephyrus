...
Source of truth: `docs/product/ZEPHYRUS-2.0-BETA-PRD.md`.
...
- D1: Is `docs/product/ZEPHYRUS-2.0-BETA-PRD.md` committed as the beta authority, moved, or intentionally kept local?
