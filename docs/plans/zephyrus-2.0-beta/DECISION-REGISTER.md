...
| D13 | PRD authority path | Commit `docs/product/ZEPHYRUS-2.0-BETA-PRD.md` or committed derivative before implementation claims authority. | B0, all | Documentation | committed authority file and docs index link | Open |
...
Enforcing artifacts: `docs/plans/zephyrus-2.0-beta/B4-patient-flow-4d-eddy-barriers.md`, Patient Flow tests
...
Enforcing artifacts: `docs/product/beta-known-limitations.md`, B6 evidence README
