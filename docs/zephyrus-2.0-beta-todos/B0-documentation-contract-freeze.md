...
- `docs/ZEPHYRUS-2.0-BETA-PRD.md` exists but is currently untracked in the worktree.
...
- `docs/ZEPHYRUS-2.0-BETA-PRD.md` or the chosen committed authority path.
- `docs/zephyrus-2.0-beta-todos/*`.
...
- [ ] `docs/zephyrus-2.0-beta-todos/evidence/B0/README.md`.
- [ ] route list output.
...
- [ ] Decide how to handle `docs/ZEPHYRUS-2.0-BETA-PRD.md`:
...
```bash
git status --short
git ls-files docs/ZEPHYRUS-2.0-BETA-PRD.md
git ls-files docs/zephyrus-2.0-beta-todos
```
...
- [ ] Start `docs/beta-known-limitations.md` or an equivalent release note file.
