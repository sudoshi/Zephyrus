...
function payload(overrides: Partial<RadiologyWorklist> = {}): RadiologyWorklist {
  return radiologyWorklistSchema.parse({
    ...
    predictiveSort: {
      ...
      enabled: false,
      requested: false,
      explanation: 'Predictive scoring is available as an opt-in planning aid.',
      model: {
        modelVersion: 'rad-risk-v1',
        modelFamily: 'logistic_regression',
        calibratedAt: '2026-07-11T14:00:00+00:00',
        synthetic: true,
        syntheticLabel: 'Synthetic planning model',
        trainingWindow: { start: '2026-06-01', end: '2026-06-30' },
        featureSchema: ['queue_depth'],
        evaluation: {
          calibrationError: 0.04,
          discriminationAuc: 0.82,
          brierScore: 0.11,
          coverage: { fraction: 1 },
          naiveBaseline: { brierScore: 0.18, discriminationAuc: 0.5 },
          beatsBaseline: true,
        },
      },
    },
