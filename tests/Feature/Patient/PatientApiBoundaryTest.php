...
class PatientApiBoundaryTest extends TestCase
{
    ...
    public function test_patient_route_inventory_is_separate_and_explicitly_gated(): void
    {
        ...
        $this->assertSame([
            ...
            'POST api/patient/v1/encounters/{encounterUuid}/education/{educationItemUuid}/clarifications',
    ...
    public function test_every_patient_feature_fails_closed_by_default(): void
    {
        ...
        foreach ([
            ...
            ['postJson', "/api/patient/v1/encounters/{$encounterUuid}/education/{$encounterUuid}/clarifications"],
    ...
    public function test_patient_profile_and_encounters_expose_only_patient_safe_handles(): void
    {
        ...
        $this->withToken($token)
            ...
            ->assertJsonMissingPath('data.encounters.0.mrn')
            ->assertJsonMissingPath('data.encounters.0.patient_ref')
            ->assertJsonMissingPath('data.encounters.0.encounter_ref')
