...
class FlowEventNormalizerTest extends TestCase
{
    public function test_parse_adt_transfer_message(): void
    {
        $raw = implode("\r", [
            ...
            'PV1||I|MS4A^MS4A-R001^MS4A-B001^SUMMIT|||ED^ED-ADULT-001^^SUMMIT|99001^ATTENDING^SYNTHETIC|||adult_med_surg|||||||||VIS000001^^^AMC^VN',
            '',
        ]);
    ...
    public function test_parse_observation_message_as_clinical_context(): void
    {
        $raw = implode("\r", [
            ...
            'PID|||SYN000001^^^AMC^MR||FLOW^SYN000001',
            'PV1||I|MS4A^MS4A-R001^MS4A-B001^SUMMIT||||99001^ATTENDING^SYNTHETIC|||adult_med_surg|||||||||VIS000001^^^AMC^VN',
