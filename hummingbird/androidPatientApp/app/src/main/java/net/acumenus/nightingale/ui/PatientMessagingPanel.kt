...
import net.acumenus.nightingale.PatientMessagingOperation
import net.acumenus.nightingale.PatientMessagingState
import net.acumenus.nightingale.data.PatientMessageAmendmentAction
import net.acumenus.nightingale.data.PatientMessageThread
import net.acumenus.nightingale.data.PatientMessageTopic
...
private fun ThreadConversation(
    ...
    var correctionTarget by remember(thread.threadUuid) { mutableStateOf<net.acumenus.nightingale.data.PatientThreadMessage?>(null) }
    var correctionDraft by remember(thread.threadUuid) { mutableStateOf("") }
    var withdrawalTarget by remember(thread.threadUuid) { mutableStateOf<net.acumenus.nightingale.data.PatientThreadMessage?>(null) }
