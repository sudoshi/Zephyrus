...
import net.acumenus.nightingale.PatientDeviceSessionOperation
import net.acumenus.nightingale.PatientDeviceSessionsState
                    ...
                    navigationIcon = {
                        IconButton(onClick = onDismiss) {
                            Icon(
                                ...
                                contentDescription = "Back to Nightingale",
                            )
                        }
                    },
            ...
            LazyColumn(
                ...
                item {
                    Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
                        ...
                        Text(
                            text = "Review devices that can currently open your Nightingale account. Device details stay on this screen only.",
...
private fun PatientDeviceSessionConfirmation(
    ...
    AlertDialog(
        ...
        text = {
            Text(
                if (session.current) {
                    "You will return to the Nightingale sign-in screen on this device. Other signed-in devices are not changed."
                } else {
