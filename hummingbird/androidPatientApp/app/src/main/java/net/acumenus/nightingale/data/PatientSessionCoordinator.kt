package net.acumenus.nightingale.data

import net.acumenus.nightingale.PatientCareTeamMember
import net.acumenus.nightingale.PatientDataContext
import net.acumenus.nightingale.PatientDestination
import net.acumenus.nightingale.PatientDischargeReadinessContact
import net.acumenus.nightingale.PatientDischargeReadinessCriterion
import net.acumenus.nightingale.PatientDischargeReadinessFollowUp
import net.acumenus.nightingale.PatientDischargeReadinessMedication
import net.acumenus.nightingale.PatientDischargeReadinessView
import net.acumenus.nightingale.PatientEducation
import net.acumenus.nightingale.PatientGoal
import net.acumenus.nightingale.PatientMilestone
import net.acumenus.nightingale.PatientPathwayEventView
import net.acumenus.nightingale.PatientPathwayEventsView
import net.acumenus.nightingale.PatientPathStep
import net.acumenus.nightingale.PatientRoundsSummaryView
import net.acumenus.nightingale.PatientRoundsTopicView
import net.acumenus.nightingale.PatientSnapshot
import net.acumenus.nightingale.PatientTodayItem
        ...
        try {
            ...
            val encounter = api.encounters(token).data.encounters.firstOrNull()
                ?: return PatientSessionOutcome.Empty(
                    ...
                    message = "No active hospital stay is available in Nightingale. Ask your care team if you expected to see one.",
                )
