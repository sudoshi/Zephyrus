...
import net.acumenus.nightingale.data.PatientImmediateHelp
import net.acumenus.nightingale.data.PatientMessageThread
import net.acumenus.nightingale.data.PatientMessageThreadTopic
import net.acumenus.nightingale.data.PatientMessageTopic
import net.acumenus.nightingale.data.PatientPreferences
import net.acumenus.nightingale.data.PatientThreadMessage
...
internal object SyntheticReferencePatientScenario {
    ...
    fun previewSessionOrNull(preview: PatientLaunchPreview): PatientSessionState? = when (preview) {
        ...
        PatientLaunchPreview.EMPTY -> PatientSessionState.Empty(
            ...
            message = "No active hospital stay is available in Nightingale.",
        )
        ...
        PatientLaunchPreview.RECOVERABLE_ERROR -> PatientSessionState.SignedOut(
            status = PatientAuthStatus.Failure(
                "Nightingale could not connect securely. Check your connection and try again.",
            ),
        )
    }
    ...
    fun snapshotOrNull(): PatientSnapshot = PatientSnapshot(
        ...
        contexts = mapOf(
            ...
            PatientDestination.MESSAGES to PatientDataContext(
                heading = "Messages",
                asOfLabel = "Updated today at 8:42 AM",
                sourceLabel = "Source: Nightingale communication service",
