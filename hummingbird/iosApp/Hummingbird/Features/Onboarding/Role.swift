...
struct Role: Identifiable, Hashable {
    ...
    static let catalog: [Role] = [
        ...
        Role(id: "case_manager", title: "Case Manager", subtitle: "Care progression, barriers & transitions", symbol: "person.text.rectangle.fill", unitBound: true),
        Role(id: "discharge_coordinator", title: "Discharge Coordinator", subtitle: "Discharge readiness & patient transitions", symbol: "door.left.hand.open", unitBound: true),
        ...
        Role(id: "ops_leader", title: "Operations Leader", subtitle: "House operations, capacity & accountable follow-up", symbol: "building.2.crop.circle.fill", unitBound: false),
