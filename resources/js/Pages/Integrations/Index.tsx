  ...
  if (isRotation) {
    ...
    return <div className="grid min-w-72 gap-1">
      ...
      <div className="grid grid-cols-2 gap-1">
        <label className="text-[11px] text-healthcare-text-secondary">Valid from<input type="datetime-local" value={rotation.validFrom} onChange={(event) => setRotation({ ...rotation, validFrom: event.target.value })} className="block w-full rounded border border-healthcare-border bg-healthcare-surface px-1 py-1 text-xs dark:border-healthcare-border-dark dark:bg-healthcare-surface-dark" /></label>
        <label className="text-[11px] text-healthcare-text-secondary">Expires at<input type="datetime-local" value={rotation.expiresAt} onChange={(event) => setRotation({ ...rotation, expiresAt: event.target.value })} className="block w-full rounded border border-healthcare-border bg-healthcare-surface px-1 py-1 text-xs dark:border-healthcare-border-dark dark:bg-healthcare-surface-dark" /></label>
        <label className="text-[11px] text-healthcare-text-secondary">Rotates at<input type="datetime-local" value={rotation.rotatesAt} onChange={(event) => setRotation({ ...rotation, rotatesAt: event.target.value })} className="block w-full rounded border border-healthcare-border bg-healthcare-surface px-1 py-1 text-xs dark:border-healthcare-border-dark dark:bg-healthcare-surface-dark" /></label>
        <label className="text-[11px] text-healthcare-text-secondary">Overlap ends<input type="datetime-local" value={rotation.overlapEndsAt} onChange={(event) => setRotation({ ...rotation, overlapEndsAt: event.target.value })} className="block w-full rounded border border-healthcare-border bg-healthcare-surface px-1 py-1 text-xs dark:border-healthcare-border-dark dark:bg-healthcare-surface-dark" /></label>
      </div>
      ...
      <p className="max-w-xs text-[11px] text-healthcare-text-secondary">Re-enter only the fields in the approved request. A mismatch fails closed.</p>
