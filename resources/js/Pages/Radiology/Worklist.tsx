...
import { AncillaryOrderTimeline, PageClockProvider, SourceFreshnessBadge } from '@/Components/Ancillary';
...
function pageHref(worklist: RadiologyWorklist, cursor: string | null) {
  ...
  Object.entries(worklist.filters).forEach(([key, value]) => {
    if (value !== null && value !== '' && key !== 'cursor' && !(key === 'lens' && value === 'all')) query.set(key, String(value));
  });
