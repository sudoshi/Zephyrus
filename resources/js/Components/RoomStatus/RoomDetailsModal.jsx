...
const TimeDisplay = ({ time, isOverdue = false }) => (
  <span className={`tabular-nums ${isOverdue ? 'text-healthcare-error dark:text-healthcare-error-dark' : 'text-healthcare-text-primary dark:text-healthcare-text-primary-dark'}`}>
    {time}
  </span>
);
