                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 p-4">
                        {renderChartSection(
                            ...
                            <div className="space-y-4">
                                <ServiceBarChart data={data.onTimeStarts.byService} height={200} />
                        ...
                        {renderChartSection(
                            ...
                            <div className="space-y-4">
                                <StackedBarChart data={data.caseLengthAccuracy.byService} height={200} />
                                <div className="grid grid-cols-3 gap-4 text-sm">
                                    <div className="bg-gray-50 p-3 rounded">
                ...
                {renderCollapsibleSection(
                    ...
                    <div className="space-y-4 p-4">
                                    ...
                                    <table className="min-w-full">
                                        <thead>
                                            <tr className="border-b bg-gray-50">
                                                ...
                                                <th className="text-right py-2 px-4">MTD</th>
                                                <th className="text-right py-2 px-4">Trend</th>
                                                <th className="text-right py-2 px-4">Projected</th>
                                        ...
                                        <tbody>
                                            {data.blockUtilization.locations.map((location, index) => (
                                                <tr key={index} className="border-b hover:bg-gray-50">
                                                    ...
                                                    <td className="text-right py-2 px-4">{location.projected}%</td>
                        ...
                        {renderChartSection(
                            ...
                            <div className="space-y-4">
                                <LineChart data={data.primetimeUtilization.trend} height={200} />
                                <div className="grid grid-cols-3 gap-4 text-sm">
                                    <div className="bg-gray-50 p-3 rounded">
                ...
                {renderCollapsibleSection(
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 p-4">
                        {renderChartSection(
                            ...
                            <div className="space-y-4">
                                <ServiceBarChart data={data.performedCases.byService} height={200} />
                                <div className="grid grid-cols-3 gap-4 text-sm">
                                    <div className="bg-gray-50 p-3 rounded">
                                    ...
                                    <div className="bg-gray-50 p-3 rounded">
                                        ...
                                        <div className="font-semibold">279</div>
                                    </div>
                                </div>
                            </div>
                        )}
                        ...
                        {renderChartSection(
                            ...
                            <div className="space-y-4">
                                <DualBarChart data={data.avgTurnover.byService} height={200} />
                                <div className="grid grid-cols-3 gap-4 text-sm">
                                    <div className="bg-gray-50 p-3 rounded">
                                        <div className="text-gray-600">Average</div>
                                        <div className="font-semibold">32m</div>
                                    </div>
                                    <div className="bg-gray-50 p-3 rounded">
                                        <div className="text-gray-600">Min</div>
                                        <div className="font-semibold">22m</div>
                                    </div>
                                    <div className="bg-gray-50 p-3 rounded">
                                        <div className="text-gray-600">Max</div>
                                        <div className="font-semibold">68m</div>
                                    </div>
                                </div>
                            </div>
                        )}
