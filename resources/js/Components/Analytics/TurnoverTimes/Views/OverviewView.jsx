    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Panel title="Total Cases" isSubpanel dropLightIntensity="medium">
          ...
          <p className="text-sm text-healthcare-text-secondary dark:text-healthcare-text-secondary-dark">Cases in selected period</p>
        </Panel>
        ...
        <Panel title="Total Turnovers" isSubpanel dropLightIntensity="medium">
          ...
          <p className="text-sm text-healthcare-text-secondary dark:text-healthcare-text-secondary-dark">Turnovers in selected period</p>
        </Panel>
      </div>
