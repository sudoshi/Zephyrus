    ...
    <div className="w-full">
      <div className="mb-4 md:hidden">
        <button
          ...
          className="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-white bg-healthcare-primary dark:bg-healthcare-primary-dark border border-transparent rounded-md shadow-sm hover:bg-healthcare-primary/90 dark:hover:bg-healthcare-primary-dark/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-healthcare-primary dark:focus:ring-healthcare-primary-dark"
        >
