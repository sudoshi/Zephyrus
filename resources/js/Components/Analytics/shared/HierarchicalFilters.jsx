          ...
          <div className="mb-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <label className="inline-flex items-center cursor-pointer">
                ...
                />
                <div className="relative w-11 h-6 bg-healthcare-border peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-healthcare-primary/30 dark:peer-focus:ring-healthcare-primary-dark/40 rounded-full peer dark:bg-healthcare-border-dark peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-healthcare-border after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-healthcare-border-dark peer-checked:bg-healthcare-primary dark:peer-checked:bg-healthcare-primary-dark"></div>
              </label>
            </div>
