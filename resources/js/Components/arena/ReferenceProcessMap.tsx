...
const KIND_STYLE: Record<ReferenceProcessNodeData['kind'], string> = {
  trigger: 'border-blue-500/70 bg-blue-50 dark:border-blue-400/70 dark:bg-blue-950/30',
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-2">
        <span className="mt-0.5 inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-healthcare-background px-1 text-[10px] font-bold tabular-nums text-healthcare-text-secondary dark:bg-healthcare-background-dark dark:text-healthcare-text-secondary-dark">
          {data.ordinal}
        </span>
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1 text-[10px] font-medium uppercase tracking-wide text-healthcare-text-secondary dark:text-healthcare-text-secondary-dark">
            {data.kind}
