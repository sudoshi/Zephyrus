...
// extracted from the Arena page so it can live behind the "Explore" mode while
// the 48-Hour Review is the default. Renders the object-centric process map
// discovered from the OCEL log (server-cached in arena.maps, mined by the
// PHI-free OCPM sidecar). Data stays `unknown` until parsed with the Zod schema
// at this boundary; every failure degrades to an in-place card.
